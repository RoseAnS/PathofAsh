...
...a brown frog still stares to the sky in disappointment and lets out a sad ribbit.  
Coming to rest once again; the forest enters a moment of calm.
The trees stand tall as they always have, yet beneath the earth they whisper through the roots to each other of tidings of change.
How do you feel? 
*[Alive] -> branch_1a
*[Alone] ->branch_1b
=== branch_1a ===
...
->branch_1_join
=== branch_1_join ===
A spiked gloved gently brushes the woodlice off some fallen logs as they begin to gather them up.
...
Then, the injured rabbit is gently placed down next to the bundle of sticks as the figure perches on a rock and pulls out a notepad.
...
Lyrics, poetry, to a new song about the dawn of a new day.

->branch_2_join
=== branch_2b ===
A warm breeze curls round the man as he writes, the last warmth of the day embracing him.
As he writes a new song, he smiles, feet firmly on the ground, a smile crosses his face as he finds a still moment amongst the trees.
...
Eyes calmly scan the riverbed thick with vegetation, he searches amongst the thick mess of greens, blues, and greys, looking for the tale-tale glint of gold. 
How do you feel?
*[Heartened]-> branch_3a
*[Concerned]-> branch_3b
=== branch_3a ===
...
->branch_3_join
=== branch_3_join ===
Landing upon the pink flower of the apple tree, the honeybee lands and begins to drink its fill. Below, colourful coat swishing about from side to side, the short figure works. 
...
For a moment, they all stare at each other in silence, the only sound to be heard the gentle blowing of the wind.
...
though they will never fully understand the secrets they <color=green>conceal</color>,
it is the choice they all make to accept each other at their word. 

Then, as one with you as you are with them, you…
-> END